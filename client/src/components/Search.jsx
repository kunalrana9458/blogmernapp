...
export default function Search() {
  ...
  useEffect(() => {
    ...
    if(searchTermFromUrl || sortFromUrl || categoryFormUrl){
      setSideBarData({...sidebarData,
        searchTerm:searchTermFromUrl || sidebarData.searchTerm,
        sort:sortFromUrl || sidebarData.sort,
        category:categoryFormUrl || sidebarData.category,
      })
    }
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          }
          {
            loading && (
              ...
              {
                showMore && <button className='teal-500 text-lg hover:underline
                p-7 w-full'
